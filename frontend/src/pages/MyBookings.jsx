...
//  when open web dfault is true after fetching make loading false
...
getmyBookings()
  ...
  return !isloading? (
    <div className='relative px-6 md:px-16 lg:px-40 pt-40 pt-30 md:pt-40 min-h-[80vh]'>
        <BlurCircle top="100px" left="100px"/>
    <div>
            <BlurCircle left="600px" bottom="0px"/>
    </div>
